...
options$kern = list(type="cmpnd",comp=list(list(type="DEtime",options=list(inverseWidthBounds=c(1/(2*max(times)),1/min(times+05)),varianceBounds=c(min(min(y),0.5),max(max(y),5)))),list(type="white")))
